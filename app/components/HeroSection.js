    ...
    <section className="relative h-screen w-full">
      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center px-4 text-center text-white md:px-8">
        ...
        <button
          ...
          className="mt-8 rounded-lg bg-primary px-6 py-2 text-base font-medium text-white transition-colors duration-300 hover:bg-secondary md:px-8 md:py-3 md:text-lg"
        >
          {ButtonText}
        </button>
      </div>
